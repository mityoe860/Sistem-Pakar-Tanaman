...
--
-- Host: localhost:3306
-- Waktu pembuatan: 16 Bulan Mei 2020 pada 03.13
...
INSERT INTO `user` (`nama`, `username`, `password`, `jenis_kelamin`) VALUES
('admin', 'admin', 'admin', 'laki-laki');
COMMIT;
